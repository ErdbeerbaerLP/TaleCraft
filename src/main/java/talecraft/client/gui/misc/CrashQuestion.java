...
public class CrashQuestion extends GuiScreen{
		...
		public void initGui() {
			...
			addButton(new GuiButtonExt(1, width/2, (height/4)*3, TextFormatting.RED+""+TextFormatting.BOLD+"Delete Folder(s)"));
		...
		// TODO Auto-generated method stub
			...
			case 2:
	            ...
	            for(String s : savesList){
	            	...
	            	FileUtils.copyFileToDirectory(new File(savesDir, s), new File(savesDir, type?".TC_MAPS":".TC_SAVES"));
	            	FileUtils.deleteDirectory(new File(savesDir, s));
	            }
				break;
