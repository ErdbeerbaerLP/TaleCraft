...
public class InvokeSwitchGui extends QADGuiScreen {
    ...
    public void buildGui() {
        ...
        {
            addComponent(QADFACTORY.createButton(TextFormatting.ITALIC + "Cancel", xOff, yOff, 120, () -> mc.displayGuiScreen(screen)).setTooltip("Do not change the invoke type and", "return the the previous screen."));
            yOff += 20;
            yOff += 4;
        }

        if ((invokeTypeFlags & InvokePanelBuilder.INVOKE_TYPE_EDIT_ALLOW_NULL) != 0) {
            addComponent(QADFACTORY.createButton("None", xOff, yOff, 120, () -> {
        ...
        if ((invokeTypeFlags & InvokePanelBuilder.INVOKE_TYPE_EDIT_ALLOW_BLOCKTRIGGER) != 0) {
            addComponent(QADFACTORY.createButton("Block Trigger", xOff, yOff, 120, () -> {
        ...
        if ((invokeTypeFlags & InvokePanelBuilder.INVOKE_TYPE_EDIT_ALLOW_COMMAND) != 0) {
            addComponent(QADFACTORY.createButton("Command", xOff, yOff, 120, () -> {
        ...
        if ((invokeTypeFlags & InvokePanelBuilder.INVOKE_TYPE_EDIT_ALLOW_SCRIPTFILE) != 0) {
            addComponent(QADFACTORY.createButton("Script File", xOff, yOff, 120, () -> {
