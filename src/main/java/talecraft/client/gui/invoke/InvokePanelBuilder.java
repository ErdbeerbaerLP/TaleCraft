...
public class InvokePanelBuilder {
     ...
     * Maximum Width: 20 + ?
     **/
    public static void build(GuiScreen screen, QADComponentContainer container, int ox, int oy, IInvoke invoke, final IInvokeHolder holder, int invokeTypeFlags) {
    ...
    private static void build_filescript(QADComponentContainer container,
        ...
        buttonReload.setAction(() -> holder.sendCommand("reload", null));
        ...
        buttonExecute.setAction(() -> holder.sendCommand("execute", null));
        ...
        buttonReloadExecute.setAction(() -> holder.sendCommand("reloadexecute", null));
    ...
    private static void build_blocktrigger(QADComponentContainer container, int ox, int oy, final BlockTriggerInvoke invoke, final IInvokeHolder holder) {
        container.addComponent(QADFACTORY.createButton("Set Region", ox, oy, 100, () -> {
        ...
        container.addComponent(QADFACTORY.createButton(QADButton.ICON_PLAY, ox + 100 + 2, oy, 20, () -> holder.sendCommand("trigger", null)).setTooltip("Trigger this invoke."));
