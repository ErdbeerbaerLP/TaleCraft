...
public class GuiStorageBlock extends QADGuiScreen {
    ...
    public void buildGui() {
        ...
        addComponent(QADFACTORY.createButton("Set Region & Store", 2, 16, 100, () -> {
        ...
        addComponent(QADFACTORY.createButton("Store", 2, 16 + (22), 100, () -> {
            String commandString = ClientNetworkHandler.makeBlockCommand(position);
            NBTTagCompound commandData = new NBTTagCompound();
        ...
        addComponent(QADFACTORY.createButton("Trigger (Paste)", 2, 16 + (22 * 2), 100, () -> {
            String commandString = ClientNetworkHandler.makeBlockCommand(position);
            NBTTagCompound commandData = new NBTTagCompound();
