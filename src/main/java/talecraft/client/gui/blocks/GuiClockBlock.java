...
public class GuiClockBlock extends QADGuiScreen {
    ...
    public void buildGui() {
...

        {
            ...
            String b = TextFormatting.RED + "Last known State: " + TextFormatting.RESET +
                    TextFormatting.BOLD + (tileEntity.active ? "ON" : "OFF") + TextFormatting.RESET +
                    ", repeat: " + tileEntity.repeat +
                    ", speed: " + tileEntity.speed +
                    ", time: " + tileEntity.time;
            addComponent(new QADLabel(b, column0x, row7y + 6));
        }
        ...
        final QADTextField fieldTime = QADFACTORY.createNumberTextField(tileEntity.set_time, column1x + 2, row5y + 2, column1w - 4, 20 * 60, 1);
