...
public class GuiLightBlock extends QADGuiScreen {
    ...
    public void buildGui() {
        ...
        QADButton buttonToggle = QADFACTORY.createButton("Toggle", 2, 40, 100, () -> {
            String commandString = ClientNetworkHandler.makeBlockCommand(position);
            NBTTagCompound commandData = new NBTTagCompound();
        ...
        QADButton buttonEnable = QADFACTORY.createButton("Enable", 2 + 100 + 2, 40, 50, () -> {
            String commandString = ClientNetworkHandler.makeBlockCommand(position);
            NBTTagCompound commandData = new NBTTagCompound();
        ...
        QADButton buttonDisable = QADFACTORY.createButton("Disable", 2 + 100 + 2 + 50 + 2, 40, 50, () -> {
            String commandString = ClientNetworkHandler.makeBlockCommand(position);
            NBTTagCompound commandData = new NBTTagCompound();
