...
public class VCUIRenderer {
	...
	public void setCurrentScreen(GuiScreen guiScreen, float zLevel, FontRenderer fontRendererObj, ItemRenderer itemRender) {
	...
	public void pushScissor(int x, int y, int width, int height) {
		...
		float factorX = MathHelper.ceil((float)vidmode.width() / (float)minecraft.currentScreen.width);
		float factorY = MathHelper.ceil((float)vidmode.height() / (float)minecraft.currentScreen.height);
