...
public abstract class QADComponent {
	...
	public abstract void onMouseClicked(double d, double e, int mouseButton);
	public abstract void onMouseReleased(double d, double e, int state);
	...
	public abstract boolean isPointInside(double mouseX, double mouseY);
	...
	public void playPressSound(float pitch) { //GuiButton
		...
		soundHandler.play(SimpleSound.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, pitch));
	}
	...
	public void mouseDragged(double d, double e, int p_mouseDragged_5_, double p_mouseDragged_6_,
		...
		this.onMouseClickMove((int)d, (int)e, p_mouseDragged_5_, (long)p_mouseDragged_8_); 
	}
