...
public class QADDropdownBox extends QADRectangularComponent {
    ...
    public void handleMouseInput() {
        ...
        if (amount < 0) {
            ...
            if (dropbox_scroll > dropbox_model.getFilteredItems().size() - dropbox_rowcount)
                dropbox_scroll = dropbox_model.getFilteredItems().size() - dropbox_rowcount < 0 ? 0 : dropbox_model.getFilteredItems().size() - dropbox_rowcount;
        }
    }
    ...
    public void postDraw(int localMouseX, int localMouseY, float partialTicks, VCUIRenderer renderer) {
        ...
        if (fieldbox_visible) {
            @SuppressWarnings("UnusedAssignment") int color = -1;
...
//				default:color = 0xFF101010;break;
    ...
    public interface ListModel {
         ...
         **/
        void onSelection(ListModelItem selected);
         ...
         **/
        List<ListModelItem> getFilteredItems();
         ...
         **/
        void drawIcon(VCUIRenderer renderer, float partialTicks, boolean light, ListModelItem item);
    }

    // The interface for list items. Pretty simple, isnt it?
    public interface ListModelItem {
        String getText();
    }
