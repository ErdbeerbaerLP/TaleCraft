...
public interface INPCAnimationInternal {
    ...
    void animate(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn, NPCModel model, NPCModelData data);

    class ZombieAnimation extends BipedAnimation {
    ...
    class PlayerAnimation extends BipedAnimation {
    ...
    class BipedAnimation implements INPCAnimationInternal {
