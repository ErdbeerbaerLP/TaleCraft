	...
	public void render(Minecraft mc,
		...
		if(playerData.hasKey("tcWand")) {
			...
			if(tcWand.hasKey("cursor")) {
				...
				GlStateManager.polygonMode(GL11.GL_FRONT, GL11.GL_POINT);
			...
			if(tcWand.hasKey("boundsA") && tcWand.hasKey("boundsB") && tcWand.getBoolean("enabled")) {
				...
				if(sv < 1024 && sv > 0) {
					...
					if(I!=null) {
						showVoid |= I.equals(Blocks.STRUCTURE_VOID.asItem());
						showVoid |= I.equals(Blocks.STRUCTURE_BLOCK.asItem());
...
//						showVoid |= I.equals(TaleCraftItems.cut);
					...
					if(showVoid) {
						final IBlockState stvoid = Blocks.STRUCTURE_VOID.getDefaultState();
