...
public class ServerFileSystem {
    ...
    public Either<NBTTagList, String> getDirectoryListing(File directory) {
        ...
        if (!directory.isDirectory()) {
            return new Either<>(null, "Given node is not a directory.");
        }
        ...
        for (File file : directory.listFiles()) {
            if (count > 0xFF) {
                ...
                return new Either<>(null, "Directory has too many entries.");
            }
        ...
        return new Either<>(nodesList, null);
    ...
    public Either<NBTTagCompound, String> getFileData(String path, boolean withContent) {
        ...
        if (file == null)
            return new Either<>(null, "The given path does not lead anywere.");
    ...
    public Either<NBTTagCompound, String> getFileData(String parent, File file, boolean withContent) {
        ...
        if (file == null)
            return new Either<>(null, "Error: No node given.");
            ...
            if (withContent) {
                try {
                    ...
                    if (content.length() > 32768) {
                        return new Either<>(null, "Error: Content too long; " + content.length() + " > 32768");
                    } else {
        ...
        return new Either<>(nodeData, null);
    }
