...
public class PlayerMirror {
	...
	public void trackInvoke(IInvokeSource source, IInvoke invoke) {
		...
		TaleCraft.network.sendTo(new StringNBTCommandPacket("client.debug.track.invoke", tagCompound), player.connection.netManager, NetworkDirection.PLAY_TO_CLIENT);
	}
