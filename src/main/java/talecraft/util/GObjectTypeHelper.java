...
public class GObjectTypeHelper {
    ...
    public static String[] findBlockState_retAStr(String fully_qualified_name) {
        ...
        if (indexOfSlash == -1) {
            ...
            typeMeta = Integer.valueOf(fully_qualified_name.substring(indexOfSlash + 1));
        }
        ...
        if (block != null) {
            if (!Block.REGISTRY.containsKey(location)) {
                System.err.println("Block type mismatch: " + fully_qualified_name + " | " + typeMod + " " + typeID + " " + typeMeta + " GOT " + block.getUnlocalizedName());
        ...
        System.err.println("Block type not found: " + fully_qualified_name + " | " + typeMod + " " + typeID + " " + typeMeta);
        return null;
    }
