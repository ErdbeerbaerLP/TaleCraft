...
public class RecursiveNBTIterator {
    ...
    public static void iterate(NBTTagCompound nbt, NBTTreeConsumer consumer) {
        iterate(nbt, consumer, 0);
    }

    private static void iterate(NBTTagCompound parent, NBTTreeConsumer consumer, int depth) {
    ...
    public interface NBTTreeConsumer {
        void consume(int depth, String name, NBTBase tag, NBTTagCompound parent);
    }
