...
public class EntityMovingBlock extends EntityFallingBlock implements IEntityAdditionalSpawnData, IInvokeSource {
    ...
    public void updateData(NBTTagCompound data) {
        ...
        if (!world.isRemote)
            TaleCraft.network.sendToDimension(new MovingBlockDataUpdatePacket(this.getEntityId(), data), getEntityWorld().provider.getDimension());
    }
    ...
    public boolean isInRangeToRenderDist(double distance) {
        return !invisible && super.isInRangeToRenderDist(distance);
    }
