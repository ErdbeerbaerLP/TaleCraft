...
public abstract class TCCommandBase extends CommandBase {
    ...
    /*
        ...
        WEST:  5; -x
     */
    public static int parseDirection(String directionStr, EntityPlayer player) throws CommandException {
        int direction = -1;

        if (directionStr.equalsIgnoreCase("east") || directionStr.equalsIgnoreCase("+x") || directionStr.equalsIgnoreCase("x"))
            direction = 3; // +x
        if (directionStr.equalsIgnoreCase("up") || directionStr.equalsIgnoreCase("+y") || directionStr.equalsIgnoreCase("y"))
            direction = 0; // +y
        if (directionStr.equalsIgnoreCase("south") || directionStr.equalsIgnoreCase("+z") || directionStr.equalsIgnoreCase("z"))
            direction = 4; // +z
    ...
    public static int parseColor(String color) throws CommandException {
    ...
    private static int hexcharToInt(char charAt) {
        return Integer.parseInt(String.valueOf(charAt).toLowerCase(), 16);
    }

    private static int hexcharToInt(char charA, char charB) {
