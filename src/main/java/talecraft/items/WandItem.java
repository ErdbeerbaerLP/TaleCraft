...
public class WandItem extends TCItem implements TCITriggerableItem {
    ...
    public static void applyWand(EntityPlayer player, BlockPos pos) {
        NBTTagCompound compound = player.getEntityData();
        NBTTagCompound tcWand;
    ...
    public static int[] getBoundsFromPlayerOrNull(EntityPlayer player) {
        return getBoundsFromPlayerDataOrNull(player.getEntityData());
    }

    public static int[] getBoundsFromPlayerDataOrNull(NBTTagCompound playerData) {
        if (playerData.hasKey("tcWand"))
            return getBoundsFromTcWandOrNull(playerData.getCompoundTag("tcWand"));
        return null;
    }

    public static int[] getBoundsFromTcWandOrNull(NBTTagCompound tcWand) {
    ...
    public static void setBounds(EntityPlayer player, int ix, int iy, int iz, int ax, int ay, int az) {
