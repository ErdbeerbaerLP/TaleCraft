...
public class EraserItem extends TCItem {
    ...
    public static boolean applyEraser(World world, EntityPlayer player, IBlockState mask) {
    ...
    public static void applyEraser(World world, IBlockState mask, int[] bounds) {
